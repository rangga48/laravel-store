                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 35%;">
                      ...
                      <div class="product-subtilte">by {{ $cart->product->user->store_name }}</div>
                    </td>
                    <td style="width: 35%;">
          ...
          <form action="" id="locations">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="zip_code" name="zip_code" value="40192">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone_number" name="phone_number" value="+61 81383585869">
              </div>
            </div>
          </div>
          <div class="row" data-aos="fade-up" data-aos-delay="150">
